...
OBJECTS = $(ODIR)/Analysis.o $(ODIR)/readparameters.o $(ODIR)/HybridMinimizer.o $(ODIR)/HcalTimeSlew.o $(ODIR)/HcalPulseShape.o $(ODIR)/PulseShapeFitOOTPileupCorrection.o $(ODIR)/HcalPulseShapes.o $(ODIR)/HLTAnalyzer.o $(ODIR)/HLTv2.o $(ODIR)/inverseGaussCDF.o $(ODIR)/PedestalSub.o
