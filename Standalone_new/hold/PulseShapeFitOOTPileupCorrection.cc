...
int fitStatusHolder = 6;
double edmStatusHolder = 0;
...
// This is the CMSSW function implementation, changed for compatibility with root ntuples for standalone code
...
//   // if(chargevalfit < 0.5){
//     std::cout << fitStatusHolder << " " << edmStatusHolder << " " << timevalfit << " " << chargevalfit << " " << timevalfit2_hold << " " << chargevalfit2_hold << " " << timevalfit3_hold << " " << chargevalfit3_hold << " ";
//     
//     for(int k = 0; k < 10; k++){
